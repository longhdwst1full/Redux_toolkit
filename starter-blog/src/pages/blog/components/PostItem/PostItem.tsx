import { deletePost, editPost, Post } from 'pages/blog.reducer'
import { useDeletePostMutation } from 'pages/blog.server'
...
export default function PostItem({ post, startEdit }: Props) {
  const dispatch = useAppDispatch()
  const [deletePostList] = useDeletePostMutation()
